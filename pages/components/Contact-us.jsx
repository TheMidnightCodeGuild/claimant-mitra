...
const Contactus = () => {
  return (
    ...
    <Navbar/>
      <div 
        className="bg-cover h-[200px] lg:h-[550px] mt-10 lg:mt-0 flex items-center bg-center object-cover justify-center bg-black flex-col relative" 
      ...
      <section className="relative z-10 overflow-hidden bg-blue-100 py-28">
      ...
      <div className="max-w-full lg:w-[95%] w-full lg:max-w-[1300px] py-10 lg:px-5 flex flex-col h-[260px] md:h-[328px] lg:h-[500px] lg:mt-20 mb-32 md:mb-20 lg:mb-8 mx-auto">
        <div className="font-bold text-center text-gray-900 lg:text-5xl text-2xl mb-20 mx-auto">
