      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
          ...
          <div className="bg-white/10 rounded-lg border border-white p-6">
            ...
            <p className="text-white/80">Total Recieved Complaints</p>
          </div>
          ...
          <div className="bg-white/10 rounded-xl border border-white p-6">
            ...
            <p className="text-white/80">Total Solved Complaints</p>
          </div>
          ...
          <div className="bg-white/10 rounded-xl border border-white p-6">
            ...
            <p className="text-white/80">Total Cashless Solved Complaints</p>
          </div>
