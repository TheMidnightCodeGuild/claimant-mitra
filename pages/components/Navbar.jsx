...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full z-50">
      {/* <button id="google_translate_element" className="sm:hidden">translate</button> */}
      <div className="bg-[#1AC0D8] text-white py-2 hidden sm:block">
        <div className="lg:max-w-[1450px] px-5 sm:px-0 mx-auto">
          <div className="flex justify-between items-center text-sm">
            <div className="flex items-center space-x-4">
              <a href="mailto:support@insurancesamadhan.com" className="flex items-center hover:text-gray-200">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                info@claimantmitra.com
              </a>
              <a href="tel:+919098645524" className="flex items-center hover:text-gray-200">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="bg-white py-2 border-b border-black/10">
        <div className="lg:max-w-[1450px] px-5 sm:px-0 mx-auto">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center gap-6 text-black font-montserrat text-[15px] font-medium">
              ...
              <div id="google_translate_element" className="px-2 py-1 rounded-md hover:bg-gray-50 transition-colors duration-200"></div>
            </div>
